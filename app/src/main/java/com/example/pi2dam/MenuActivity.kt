...
class MenuActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnSuppliers = findViewById<MaterialButton>(R.id.btnMenuSuppliers)
        ...
        btnSuppliers.setOnClickListener { startActivity(Intent(this, SuppliersActivity::class.java)) }
